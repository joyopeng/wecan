 ...
 */
public class MyNewestStateFragmentAdapter extends BaseAdapter {
    ...
    public MyNewestStateFragmentAdapter(String prospectPerson,Context context, List<MyNewestStateFragmentData> list) {
    ...
    public static class MyNewestStateFragmentData {
