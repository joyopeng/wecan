 ...
 */
public class ProspectingFragmentAdapter extends BaseAdapter {

    //List<String> list;
    private List<ProspectingFragmentData> list = new ArrayList<ProspectingFragmentData>();
    private LayoutInflater inflater;
    private LinearLayout itemLinearLayout;
    Context context;

    public ProspectingFragmentAdapter(Context context, List<ProspectingFragmentData> list) {
    ...
    public View getView(final int arg0, View view, ViewGroup arg2) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.prospecting_fragment, null);
...
//        viewHolder.exposureProcess.setText(list.get(arg0).getExposureProcess());
    ...
    public static class ProspectingFragmentData {
