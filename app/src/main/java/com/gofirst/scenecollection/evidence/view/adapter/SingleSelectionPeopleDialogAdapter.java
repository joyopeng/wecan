 ...
 */
public class SingleSelectionPeopleDialogAdapter extends BaseAdapter {
    ...
    public SingleSelectionPeopleDialogAdapter(Context context,List<String> list,String employeeName,String text) {//String[] beans
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(
                    R.layout.single_choicl_list_pop_item, null);
...
*/
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        SingleSelectionPeopleDialogAdapter.isSelected = isSelected;
    }
}
