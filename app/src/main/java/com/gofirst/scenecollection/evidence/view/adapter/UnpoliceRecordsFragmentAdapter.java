 ...
 */
public class UnpoliceRecordsFragmentAdapter extends BaseAdapter {
    ...
    public UnpoliceRecordsFragmentAdapter(Context context, List<UnpoliceRecordsFragmentData> list) {
...
//        viewHolder.exposureProcess.setText(list.get(arg0).getExposureProcess());
    ...
    public static class UnpoliceRecordsFragmentData {
