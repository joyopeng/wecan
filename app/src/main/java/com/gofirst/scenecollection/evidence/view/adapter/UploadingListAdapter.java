...
public class UploadingListAdapter extends BaseAdapter {
    ...
    public UploadingListAdapter(List<CsSceneCases> datas){
        this.datas = datas;
    }
    @Override
    public int getCount() {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.uploading_file_list_item,parent,false);
