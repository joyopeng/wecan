...
import com.gofirst.scenecollection.evidence.view.adapter.ProspectingFragmentAdapter;
import com.gofirst.scenecollection.evidence.view.adapter.ProspectingFragmentAdapter.ProspectingFragmentData;
 ...
 */
public class ProspectingFragment extends Fragment {
    ...
    private ProspectingFragmentAdapter adapter;
    private List<ProspectingFragmentAdapter.ProspectingFragmentData> list = new ArrayList<ProspectingFragmentAdapter.ProspectingFragmentData>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.allquery_fragment, null);
                        ...
                        ProspectingFragmentData prospectingFragmentData;
        ...
        for (int i = 0;i<crackedDate.length;i++) {
            crackedDate[i] = simpleDateFormat.format(new Date(baseTime + 2 * i * 60 * 1000));
                        ...
                        for (int i = 0; i < sceneDetail.length; i++) {
                            ...
                            prospectingFragmentData = new ProspectingFragmentData();
                            ...
                            prospectingFragmentData.setInvestigationPlace(sceneDetail[i]);
                            prospectingFragmentData.setExposureProcess(exposureProcess[i]);
                            prospectingFragmentData.setSceneRegionalismName(sceneRegionalismName[i]);
                            prospectingFragmentData.setCrackedDate(crackedDate[i]);
                            prospectingFragmentData.setCaseSolve(caseSolve[i]);
                            if (caseSolve[i].equals("1")) {
                                list.add(prospectingFragmentData);
                            }
                        }
...
//                        adapter.notifyDataSetChanged();
        ...
        adapter = new ProspectingFragmentAdapter(getActivity(),list);
