...
public class CircleTextImageView extends ImageView {
    ...
    public CircleTextImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(com.thinkcool.circletextimageview.R.styleable.CircleTextImageView_citv_border_width, DEFAULT_BORDER_WIDTH);
        mBorderColor = a.getColor(com.thinkcool.circletextimageview.R.styleable.CircleTextImageView_citv_border_color, DEFAULT_BORDER_COLOR);
        mBorderOverlay = a.getBoolean(com.thinkcool.circletextimageview.R.styleable.CircleTextImageView_citv_border_overlay, DEFAULT_BORDER_OVERLAY);
        mFillColor = a.getColor(com.thinkcool.circletextimageview.R.styleable.CircleTextImageView_citv_fill_color, DEFAULT_FILL_COLOR);
        mTextString = a.getString(com.thinkcool.circletextimageview.R.styleable.CircleTextImageView_citv_text_text);
        mTextColor = a.getColor(com.thinkcool.circletextimageview.R.styleable.CircleTextImageView_citv_border_color, DEFAULT_TEXT_COLOR);
        mTextSize = a.getDimensionPixelSize(com.thinkcool.circletextimageview.R.styleable.CircleTextImageView_citv_text_size, DEFAULT_TEXT_SIZE);
        mTextPadding=a.getDimensionPixelSize(com.thinkcool.circletextimageview.R.styleable.CircleTextImageView_citv_text_padding, DEFAULT_TEXT_PADDING);
        a.recycle();
