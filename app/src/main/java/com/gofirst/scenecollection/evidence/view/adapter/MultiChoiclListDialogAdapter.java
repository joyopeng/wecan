 ...
 */
public class MultiChoiclListDialogAdapter extends BaseAdapter {
    ...
    public MultiChoiclListDialogAdapter(Context context,List<String> list,String employeeName,String text) {//String[] beans
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        MultiChoiclListDialogAdapter.isSelected = isSelected;
    }
}
