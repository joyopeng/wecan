...
public class RFID extends LinearLayout implements BaseView{
    ...
    public RFID(Context context) {
        super(context);
        initLayout(context);
    }

    public RFID(Context context, AttributeSet attrs) {
        super(context, attrs);
        initLayout(context);
    }

    public RFID(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        startPop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mode.equals(BaseView.EDIT)) {
                    ...
                    intent.setClass(getContext(), module_bluedemo.MainActivity.class);
