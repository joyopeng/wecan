 ...
 */
public class PermissionSetingHorizNavView extends LinearLayout implements View.OnClickListener {
    ...
    public PermissionSetingHorizNavView(Context context) {
        super(context);
    }

    public PermissionSetingHorizNavView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        public void onBindViewHolder(AgeItemViewHolder holder, final int position) {
            ...
            holder.getTextView().setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent("violetjack.permissionSet");
