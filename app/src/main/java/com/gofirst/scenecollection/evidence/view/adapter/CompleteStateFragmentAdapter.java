 ...
 */
public class CompleteStateFragmentAdapter extends BaseAdapter {
    ...
    public CompleteStateFragmentAdapter(String prospectPerson,Context context, List<CompleteStateFragmentData> list) {
        ...
        //if (view == null) {
            ...
            viewHolder.itemLinearLayout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("reportTime",list.get(arg0).getReportTime());
                    intent.putExtra("alarmPeople",list.get(arg0).getAlarmPeople());
    ...
    public static class CompleteStateFragmentData {
