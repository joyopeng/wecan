...
public class Util {
	 ...
	 * @return
	 */
	public ArrayList<String>  listAlldir(long time){
		Intent intent = new Intent(Intent.ACTION_PICK,android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
		Uri uri = intent.getData();
		ArrayList<String> list = new ArrayList<String>();
		String[] proj ={MediaStore.Images.Media.DATA};
		Cursor cursor = context.getContentResolver().query(uri, proj, MediaStore.Images.Media.DATE_TAKEN + " > " + time, null, null);//managedQuery(uri, proj, null, null, null);
	...
	public List<FileTraversal> LocalImgFileList(long time){
		List<FileTraversal> data=new ArrayList<FileTraversal>();
		String filename="";
		List<String> allimglist=listAlldir(time);
